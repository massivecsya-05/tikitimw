    ...
    return (
      <PageShell>
        <div className="container mx-auto px-4 py-32 text-center">
          <h1 className="font-display font-bold text-2xl mb-2">This event isn't available</h1>
          <p className="text-muted-foreground mb-6">It may have been cancelled or is no longer listed.</p>
          <Button asChild variant="hero"><Link to="/events">Browse other events</Link></Button>
        </div>
      </PageShell>
    );
  }
